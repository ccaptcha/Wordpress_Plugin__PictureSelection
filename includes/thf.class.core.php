...
/*
 * Themesfa CCaptcha Picture Selection: Handle Core functions
 */

class THF_CCAPTCHA_PS_Core {
	...
	public function get_option( $key, $default = false ) {
		$options = get_option( 'thf_ccaptcha_ps', [] );
	...
	public function default_options() {
		return [
			...
			'messages'    => [
				'no_answer'    => __( 'Please complete the captcha.', THF_CCAPTCHA_PS_DOMAIN ),
				'wrong_answer' => __( 'Please enter correct captcha value.', THF_CCAPTCHA_PS_DOMAIN ),
			],
		];
	}
	...
	public function verify() {
		$wrong_answer = thf_ccaptcha_ps()->CORE->get_option( 'messages.wrong_answer' );
		$no_answer    = thf_ccaptcha_ps()->CORE->get_option( 'messages.no_answer' );
...
/**
 * @return THF_CCAPTCHA_PS_Core
 */
function thf_ccaptcha_ps_core() {
	return THF_CCAPTCHA_PS_Core::init();
}
